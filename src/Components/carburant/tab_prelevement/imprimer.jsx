...
const Recherche_multiple_prelevement = () => {
    //carburant function
    ...
    useEffect(() => {
                axios.get(`${process.env.REACT_APP_SERVICE_API}pleinCarID/${siteSession}/${carURL}`,
                    {
                        headers: {
...
export default Recherche_multiple_prelevement;