                            ...
                            <div>
                                <View style={styles.table}>
                                    <View style={styles.tableRow}>
                                        ...
                                        <View style={styles.tableColHeader}>
                                            <Text style={styles.tableCellHeader}>Km Initial</Text>
                                        </View>
                                        <View style={styles.tableColHeader}>
                                            <Text style={styles.tableCellHeader}>Km Final</Text>
                                        </View>
                                        <View style={styles.tableColHeader}>
                                            <Text style={styles.tableCellHeader}>Km parcourus</Text>
                                        </View>
                                        <View style={styles.tableColHeader}>
                                            <Text style={styles.tableCellHeader}>Total L</Text>
                                        </View>
                                        <View style={styles.tableColHeader}>
                                            <Text style={styles.tableCellHeader}>C L/100 Km</Text>
                                        </View>
                                        <View style={styles.tableColHeader}>
                                            <Text style={styles.tableCellHeader}>Nbre de plein</Text>
                                        </View>
                                    </View>
                                    <center>
                                        {
                                    ...
                                    {carss.map((item) => (
                                        <>
                                            <View key={item.id} style={styles.tableRow}>
                                                ...
                                                <View style={styles.tableCol}>
                                                    <Text style={styles.tableCell}>{item.NomZone}</Text>
                                                </View>
                                                <View style={styles.tableCol}>
                                                    <Text style={styles.tableCell}>{dateFormat(item.datesyst, "dd/mm/yyyy") + 'au ' + '30/04/2015'}</Text>
                                                </View>
                                                <View style={styles.tableCol}>
                                                    <Text style={styles.tableCell}>{item.KmInitial}</Text>
                                                </View>
                                                <View style={styles.tableCol}>
                                                    <Text style={styles.tableCell}>{item.KmFinal}</Text>
                                                </View>
                                                <View style={styles.tableCol}>
                                                ...
                                                <View style={styles.tableCol}>
                                                    <Text style={styles.tableCell}>{item.Cl}</Text>
                                                </View>
                                                <View style={styles.tableCol}>
...
export default PdfprelevementAllC;