...
const ImprimerID = () => {
    ...
    useEffect(() => {
                ...
                axios.get(`${process.env.REACT_APP_SERVICE_API}pleinIDC/${siteSession}/${pleinCarDate}`,
                    {
                        headers: {
                                ...
                                <View style={styles.table}>
                                    ...
                                    {carss.map((item) => (
                                        <View key={item.id} style={styles.tableRow}>
                                            ...
                                            <View style={styles.tableCol}>
                                                <Text style={styles.tableCell}>{item.immatriculation + "/" + item.id}</Text>
                                            </View>
                                            <View style={styles.tableCol}>
